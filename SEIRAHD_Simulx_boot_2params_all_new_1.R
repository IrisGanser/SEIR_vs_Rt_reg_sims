...
initializeLixoftConnectors(software = "monolix", path = "/cm/shared/dev/modules/generic/apps/tools/monolix/2019R2/")


dir <- "~/MonolixFiles/2023-09-06_boot_sim_Simulx_2params_all_SEIRAHD"

for(j in 1:2){
  # resample data
  data <- read.table(paste0("data_sim_SEIRAHD_Simulx_2params_all_new_ME", j, ".txt"), header = TRUE, sep = ",") 
  ...
  for(i in 1:100){
    ...
    ProjectName = paste0("SEIRAHD_Simulx_new_2params_", j, "boot", i)
