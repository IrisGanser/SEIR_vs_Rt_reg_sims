...
dir <- "~/MonolixFiles/2023-11-09_boot_sim_new4_Simulx_SEIR"

for(j in 1:5){
  # resample data
  data <- read.table(paste0("data_sim_SEIR_Simulx_2params_new4_ME", j, ".txt"), header = TRUE, sep = ",") 
  ...
  for(i in 1:100){
    ...
    ProjectName = paste0("SEIR_Simulx_new4_2params_", j, "boot", i)
